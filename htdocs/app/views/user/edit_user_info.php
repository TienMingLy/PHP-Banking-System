<html>
	<head>
		<link rel="stylesheet" type="text/css" href="../css/user/edit_user_info.css">
	...
	<body>
		<div id="editInfoDiv">
			...
			?>
					...
					<br/><br/>
					<label id="personalInfoLabel"><?php echo $_SESSION['username']?>'s Personal Information</label>
					<br/>
			...
			?>
			<a href="listAllUser"><h2>Back to Users</h2></a>	
			</form>
		</div>
	</body>
</html>
