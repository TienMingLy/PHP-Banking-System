...
<div id="theBankPicture">
  <a href="index"><img src="../../images/TheBank_Logo_Transparent.png" id="theBankLogoImg" alt="Sky Bank Logo"></a>
</div>
  ...
  <div class="container-fluid"  id="divforNavBar">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a id="logoutLink" name="logout" href='<?php echo"/user/logout " ?>'><span class="glyphicon glyphicon-log-out"></span>Logout</a></li>
    </ul>
  </div>
</div>
</nav> 