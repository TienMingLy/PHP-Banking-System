<html>
	<head>
		<link rel="stylesheet" type="text/css" href="../css/user/edit_user_contact_info.css">
	...
	<body>
		<div id="editInfoDiv">
			...
			?>
					...
					<br/><br/>
					<label id="personalContactInfoLabel"><?php echo $_SESSION['username']?>'s Contact Information</label>
					<br/>
