<html>
	<head>
		<link rel="stylesheet" type="text/css" href="../css/adminLevel_2/edit_user_account_status.css">
	...
	<body>
		<div id ="editUserAccountStatusDiv">
			<form action='' method='post' id="edit_user_account_status">
				...
				<h2 id="accountH2">Account's username: <?php echo $_SESSION['client_username'];?></h2>		
