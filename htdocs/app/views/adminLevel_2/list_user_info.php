<html>
	<head>
		<link rel="stylesheet" type="text/css" href="../css/adminLevel_2/list_user_info.css">
			...
			<table width="600" border="1" cellpadding="1" cellspacing="1" id="userInfoTable">
				...
				?>
						<tr>
							...
							<td><a href="editUserInfo2?User_id=<?=$user['User_id']?>"><input type="submit" value="View"></input></a></td>
						</tr>
				<?php
					}
				?>
