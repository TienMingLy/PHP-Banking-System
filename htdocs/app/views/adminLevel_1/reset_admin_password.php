<html>
	<head>
		<link rel="stylesheet" type="text/css" href="../css/adminLevel_1/reset_admin_password.css">
		<title>Reset Admin's Password Page</title>
	</head>
	
	<body>
		<div id="resetAdminPasswordDiv">
			<form action='' method='post' id="reset_password_Form">
				...
				<br/>
				<label id="usernameLabel">Username<input type="text" id="usernameInput" name='username' value="<?php echo $_SESSION['admin_username']?>" readonly/></label>
				<br/>
