<html>
	<head>
		<link rel="stylesheet" type="text/css" href="../css/adminLevel_1/list_user_contact_info.css">
			...
			<table width="600" border="1" cellpadding="1" cellspacing="1" id="userContactInfoTable">
				...
				?>
						<tr>
							...
							<td><a href="editUserContactInfo1?User_id=<?=$user['User_id']?>"><input type="submit" value="Edit"></input></a></td>
						</tr>
				<?php
					}
				?>
